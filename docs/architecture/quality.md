---
title: Quality
description: The quality goals broken down into scenarios that can be checked.
sidebar:
  order: 10
---
...
Break each goal from [Goals](goals.md) into the qualities that make it up. Use a nested list.
